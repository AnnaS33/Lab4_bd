...
public class Frog implements Watcher {
        ...
        public Frog(String animalName, String hostPort, int partySize,String root) {
        ...
        public static void main(String[] args) {
            ...
            //Создаём объект
            Frog animal = new Frog(args[0], args[1],Integer.parseInt(args[2]),"/zoo");
            ...
            try {
                ...
                System.out.println("Frog was not permitted to the zoo. " + e);
            }
        }
