...
public class Cat implements Watcher{
    ...
    public Cat(String animalName, String hostPort, int partySize,String root) {
    ...
    public static void main(String[] args) {
        ...
        //Создаём объект
        Cat animal = new Cat(args[0], args[1],Integer.parseInt(args[2]),"/zoo");
        ...
        try {
            ...
            System.out.println("Cat was not permitted to the zoo. " + e);
        }
    }
